...
This line graph compares the top 10 most popular starting stations between **casual riders** and **members** for Cyclistic bikes. The x-axis lists the start station names, while the y-axis indicates the number of rides that originated from each station. The two lines represent casual riders (blue) and members (orange), showing the number of riders for each member type at these stations. 
...
- Casual riders tend to favor waterfront stations such as **Streeter Dr & Grand Ave**, **Millennium Park**, **DuSable Lake Shore Dr & North Blvd**, and **Michigan Ave & Oak St**. Meanwhile, members show a more balanced use across various stations. 
...
These stations are typically located in areas that attract tourists or casual users who may ride for leisure or sightseeing purposes.
...
The bar chart titled "Average Ride Lengths: Casual Riders vs. Members" compares the average ride duration between casual riders and members in minutes. The chart displays two bars, with casual riders represented in blue and members in orange. **Casual riders** average around **13 minutes per ride**, while **members** have shorter average rides, around **9 minutes**.
...
**From the data:**
- **Members use bikes more extensively:** Members have logged significantly more total ride time compared to casual riders—approximately 25 million minutes versus around 19.6 million minutes. This suggests that members tend to use the bikes more frequently or take longer trips overall.
...
This bar chart compares the **average ride length (in minutes)** of casual riders and annual members across each day of the week. The x-axis represents the days of the week, with each day split into two bars: one for casual riders and one for members. The y-axis indicates the average ride length in minutes.
...
This suggests that casual riders tend to use the service more for leisure or extended trips on weekends, especially Sundays. Members, on the other hand, likely use the service for commuting or regular shorter trips, having more consistent and shorter ride lengths throughout the week, with an average of about 8 minutes of ride length.

## 7. Weekly Ride Patterns
<img src="images/Weekly_Ride_Patterns.png" alt=" Weekly Ride Patterns" width="900">

This bar chart visualizes the Weekly Ride Patterns of Cyclistic bike riders, comparing the ride counts of casual riders and members over the course of a week. Each day of the week is represented on the x-axis, while the y-axis shows the number of riders.
...
- **Monday to Thursday:** Members exhibit a significant peak in activity between Monday and Thursday, with the highest number of rides recorded on Tuesday (453,990 rides), Wednesday (449,026 rides), and Thursday (452,568 rides). In contrast, casual riders have a relatively lower and more consistent ride pattern during the workweek, ranging between 182,257 and 190,726 rides.
- **Friday:** Casual riders’ ride counts start to increase on Friday, with 219,852 rides, which is significantly higher than their weekday rides. Members continue to show strong activity on Fridays as well, logging 392,006 rides.
...
Understanding these weekly patterns allows Cyclistic to better tailor its marketing strategies, ensuring that casual riders are targeted with promotions that fit their weekend usage habits, while members can be encouraged to continue their high weekday usage.

## 8. Rides by Time of Day
<img src="images/Rides_by_Time_of_Day.png" alt="Rides by Time of Day" width="900">

This line chart shows the total ride length in minutes for **casual riders** and **members** throughout the day, from **12 AM to 11 PM**. The x-axis represents the time of day, and the y-axis represents the total ride length in minutes. The two lines represent casual riders (blue) and members (orange).

**Casual Riders (blue line):**

- Activity gradually rises from early morning (around 5 AM), reaching a peak between **4 PM and 6 PM**.
...
- Member usage is more consistent throughout the day compared to casual riders, with a notable dip during **midday** but higher levels of activity overall.
